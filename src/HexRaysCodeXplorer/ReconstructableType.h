...
extern  SyncTypeInfoMethod syncTypeInfoMethod;
...
class  ReconstructedMemberReType : public ReconstructedMemberType
{
public:
...
class  MemberTypeIDAFlagsTGate : public ReconstructedMemberType
{
...
class  MemberTypeIDATypeInfoGate : public ReconstructedMemberType
{
...
class  MemberTypePointer : public ReconstructedMemberType
{
public:
...
class  ReconstructableTypeVtable : public ReconstructableType
{
...
extern  std::map<std::string, ReconstructableType *> g_ReconstractedTypes;
